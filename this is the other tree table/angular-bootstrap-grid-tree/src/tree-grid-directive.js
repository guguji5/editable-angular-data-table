        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "       ng-class=\"'level-' + {{ row.level }} + (row.branch.selected ? ' active':'')\" ng-click=\"on_user_click(row.branch);user_clicks_branch(row.branch)\" class=\"tree-grid-row\">\n" +
                    ...
                    "              <span  ng-if=\"!expandingProperty.cellTemplate\" class=\"indented tree-label\" ng-click=\"\">\n" +
